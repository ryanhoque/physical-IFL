"""
A robot that can exert force in cardinal directions. The robot's goal 
is to reach the goal location specified in map.txt. State
...
class Map:
    ...
    def __init__(self, filename="env/map.txt"):
...
class Navigation(Env, utils.EzPickle):
    ...
    def step(self, a, noiseless=False):
        ...
        # print(self.time, self.state, a, next_state)
...
if __name__ == '__main__':
    ...
    for i in range(HORIZON - 1):
        # print(env.step([0, -1]))
        print(env.step(env.expert_action(env.state)))
